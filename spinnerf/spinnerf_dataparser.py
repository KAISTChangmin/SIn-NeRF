...
@dataclass
class SPInNeRFDataParserConfig(DataParserConfig):
    """SPInNeRF dataset config"""

    _target: Type = field(default_factory=lambda: SPInNeRF)
...
@dataclass
class SPInNeRF(DataParser):
    """SPInNeRF DatasetParser"""
